...
- Show a dimmed menu-bar icon when stopped, a spinner while starting/restarting, and the normal icon when running
...
Run the local authentication and menu-bar state tests with `swift test`.
